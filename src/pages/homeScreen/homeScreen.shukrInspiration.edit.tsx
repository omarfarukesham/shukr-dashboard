...
const ShukrPostEditPage = () => {
  ...
  // Extract post data from nested structure
  ...
  if (!post) return <div>No data found for this post.</div>;

  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-xl font-bold">Edit Shukr Post</h1>
        <button onClick={() => navigate("/shukr-ins")} className="bg-primary hover:bg-secondary text-white rounded text-xs py-1 px-1 flex items-center">
